...
import { Camera, Star, Sparkles as SparkleIcon, Heart, X, Smile, ShieldCheck, MessageSquare, ExternalLink } from 'lucide-react';
...
const CollaborationModellingShoots = () => {
  ...
  const [coverImage] = useState(() => {
    ...
    return covers.find(c => c.id === 'collab')?.imageUrl || "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?auto=format&fit=crop&w=1000&q=80";
  });
        ...
        <div className="container mx-auto flex flex-col lg:flex-row items-center w-full relative z-10">
          ...
          <div className="w-full lg:w-1/2 h-[350px] md:h-[450px] lg:h-[550px] order-1 lg:order-2 relative z-10 flex items-center justify-center p-4">
            ...
            >
              <img
                src={coverImage}
                alt="Editorial photoshoot fashion studio setup"
