...
import { Flower2, Star, Sparkles as SparkleIcon, Heart, X, Smile, ShieldCheck, MessageSquare, ExternalLink } from 'lucide-react';
...
const PubertyCeremonyEvents = () => {
  ...
  const [coverImage] = useState(() => {
    ...
    return covers.find(c => c.id === 'puberty')?.imageUrl || "https://images.unsplash.com/photo-1606216794074-735e91aa2c92?auto=format&fit=crop&w=1000&q=80";
  });
        ...
        <div className="container mx-auto flex flex-col lg:flex-row items-center w-full relative z-10">
          ...
          <div className="w-full lg:w-1/2 h-[350px] md:h-[450px] lg:h-[550px] order-1 lg:order-2 relative z-10 flex items-center justify-center p-4">
            ...
            >
              <img
                src={coverImage}
                alt="Traditional Indian Flower Stage Decor"
