...
const STATIC_EVENTS_CTA_PARTICLES = [...Array(15)].map(() => ({
  top: `${Math.random() * 100}%`,
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-full bg-[radial-gradient(ellipse_at_center,_rgba(127,231,231,0.15)_0%,transparent_70%)] blur-2xl" />
        ...
        <div className="absolute inset-0 pointer-events-none opacity-30">
          {STATIC_EVENTS_CTA_PARTICLES.map((p, i) => (
            <div
              key={i}
              ...
              style={{
                top: p.top,
                left: p.left,
                animation: `ctaFloat ${p.duration} ease-in-out ${p.delay} infinite`,
              }}
            />
          ))}
        </div>
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-30 text-center">
        ...
        >
          ...
          <motion.h2
            ...
            className="text-3xl md:text-5xl lg:text-6xl font-heading font-bold text-white mb-6 leading-tight text-glow relative z-10"
          >
          ...
          >
            Whether you're planning a wedding, corporate event, brand campaign,
            or a memorable surprise, our team is ready to bring your vision to
            life.
          </motion.p>
